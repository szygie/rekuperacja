...
public class ControlLevel2 extends HttpServlet {
    ...
    protected void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        tryb2.setShutdownOptions(true, PinState.HIGH);
        ...
        response.getWriter().println("<h1>Włączono PIN 20 </h1>");
